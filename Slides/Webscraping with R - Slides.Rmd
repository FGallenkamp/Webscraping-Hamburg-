...
Die Umfrageergebnisse liegen als "strings" vor, sodass wir sie für die Daten-
analyse in numerische Werte umwandeln müssen.
...
allensbach.df <- html.table %>%
  rename("Zeitpunkt" = 1) %>%
  mutate(Zeitpunkt = parse_datetime(Zeitpunkt, 
                                    format = "%d.%m.%Y")) %>%
