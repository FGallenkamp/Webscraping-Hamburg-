...
p_load(tidyverse, knitr, httr, kableExtra)
```
...
In R ist Web Scraping über das Paket [`rvest`](https://github.com/hadley/rvest) möglich:

1. `read_html`: Lesen von HTML/XML-Dateien
2. `html_nodes`: Extrahiert Teile des HTML-Dokument mit Hilfe von XPATH/CSS-Selektoren
3. `html_text`/`html_attr`: Extrahiert Text oder Attribute
