...
p_load(tidyverse, rvest, knitr, httr, kableExtra)
```
...
```
Source: [Wickham & Grolemund (2018)](https://r4ds.had.co.nz/introduction.html)
...
3. `html_nodes`: Extrahiert Teile des HTML-Dokument mit Hilfe von XPath/CSS-Selektoren
4. `html_text`/`html_attr`: Extrahiert Text oder Attribute
